...
def embed(request):
    ...
    try:
        ...
        for bounty in bounties:
            i += 1
            value = "{} {}, (${} @ {} USD/{})".format(round(bounty.value_true, 2), bounty.token_name, round(bounty.value_in_usdt, 2), round(convert_token_to_usdt(bounty.token_name), 2), bounty.token_name)
